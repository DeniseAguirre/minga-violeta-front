...
export default function SignIn() {
  ...
  function handleForm(e) {
    ...
    axios
      .post(VITE_API + "auth/signin", data)
      .then((res) => {
          ...
          <div className="flex flex-col w-full">
            <form onSubmit={(e) => handleForm(e)}>
              <div className="flex flex-col items-center">
                <h1 className="text-xl text-center font-semibold text-gray-800 tracking-wider">
              ...
              <input
                className="mt-4 mb-3 w-full bg-gradient-to-b from-[#F9A8D4] to-[#F472B6] text-white py-2 rounded-xl transition duration-100 shadow-cyan-600 font-bold  text-xl h-12 cursor-pointer"
                type="submit"
                value="Sign in"
              />
            </form>
